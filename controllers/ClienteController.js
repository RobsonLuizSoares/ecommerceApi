...
class ClienteController {
    ...
    */
    ...
    async showPedidosCliente(req, res, next) {
        const { offset, limit, loja } = req.query
        try {
            const pedidos = await Pedido.paginate({ loja, cliente: req.params.id }, {
    ...
    */
    ...
    async store(req, res, next) {
        ...
        const cliente = new Cliente({ nome, email, cpf, telefones, endereco, loja, dataNascimento, usuario: usuario._id })
